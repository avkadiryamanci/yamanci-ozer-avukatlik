...
(DIST/'blog/index.html').write_text(page('Blog — Hukuki Yazılar', 'Yamancı Özer ekibinden 18 hukuki yazı: kentsel dönüşüm, gayrimenkul, ticaret, sözleşmeler, kira, aile, miras ve icra hukuku.', intro+guide+others), encoding='utf-8')
for a in articles:
    ...
    (path/'index.html').write_text(page(a['title'], a['summary'], body, schema), encoding='utf-8')
